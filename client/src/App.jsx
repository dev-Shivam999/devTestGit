  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route
          path="/embassy-government-partners"
          element={<ForGovernmentEmbassies />}
        />
        <Route
          path="/tenant-and-domestic-help-verification"
          element={<TenantVerification />}
        />
        <Route path="/india-evisa" element={<IndianEvisa />} />
        <Route
          path="/global-recruitment-services"
          element={<Globalrecruitmentservices />}
        />
        ...
        <Route
          path="/digital-arrival-cards"
          element={<Digitalarrivalcards />}
        />
        <Route
          path="/dubai-5year-tourist-visa"
          element={<Dubai5yeartouristvisa />}
        />
        <Route
          path="/south-korea-visa-for-indians"
          element={<Southkoreavisaforindians />}
        />
        <Route path="/morocco-visa" element={<Moroccovisa />} />
        <Route
          path="/serbia-work-permit-visa"
          element={<Serbiaworkpermitvisa />}
        />
        <Route
          path="/australia-tourist-visa"
          element={<Australiatouristvisa />}
        />
        <Route
          path="/malaysia-visa-for-indians"
          element={<Malaysiavisaforndians />}
        />
        <Route path="/company-setup-in-the-uae" element={<Companysetup />} />
        <Route path="/apply-for-any-visa" element={<Applyforanyvisa />} />
        <Route
          path="/japan-tourist-visa-for-indians"
          element={<Japantouristvisaforindians />}
        />
        <Route
          path="/egypt-visa-for-indians"
          element={<Egyptvisaforindians />}
        />
        <Route path="/tnh-magazine" element={<Magazine />} />
        <Route path="/bangladesh-vac" element={<BangladeshVac />} />
        <Route
          path="/bangladesh-visas-for-uae-singapore"
          element={<BangladeshVisasForUaeSingapore />}
        />

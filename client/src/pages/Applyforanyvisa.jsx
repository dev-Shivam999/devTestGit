...
const Applyforanyvisa = () => {
  ...
  const fetchFormData = async () => {
    try {
      ...
      const response = await fetch(
        `${BackendURL}/api/forms/slug/apply-for-any-visa`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${BackendURL}/api/form-submissions/slug/apply-for-any-visa`,
        {
          method: "POST",
  ...
  const whyDuGlobalSection =
    contentSections["Why DU GLOBAL"] || contentSections["Why DU Global"] || [];
  ...
  const whyDuGlobalItems = [
    {
      ...
      description:
        "Since 2015, the company has been expanding its offerings and geographical reach.",
    },
    {
      icon: Clock,
      title: "Speed",
      description:
        "Prioritizing your time with quick processing and efficient service delivery.",
    },
    {
      icon: Shield,
      title: "Fast Delivery",
      description: "Hassle-free passport delivery right to your doorstep.",
    },
    {
      icon: Globe,
      title: "Trusted Network",
      description:
        "35+ locations across 6 countries with global partner offices.",
    },
  ];
  ...
  return (
    <div className="bg-white font-sans">
      ...
      <section
        className="relative w-full py-32 bg-cover bg-center min-h-[800px] sm:h-[800px] flex items-center"
        style={{
                  ...
                  <>
                    ...
                    {checkboxFields.map((field, index) => (
                      <label
                        ...
                        className="flex items-start gap-3 text-gray-600 cursor-pointer mb-4">
                        <input
                          type="checkbox"
                          name={field.name}
                ...
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      />
                      <span className="text-5xl font-bold text-gray-900">
                        17<span className="text-2xl">Lac+</span>
                      </span>
                    </div>

...
const IndianEvisa = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${BackendURL}/api/form-submissions/slug/india-evisa`,
        {
          method: "POST",
      ...
      if (response.ok) {
        ...
        setSubmitMessage(
          "Thank you! Your eVisa application has been submitted successfully. Our team will contact you shortly."
        );
        // Reset form
        const resetValues = {};
  ...
  if (loading)
    return <LoadingState message="Loading eVisa information..." fullScreen />;
  if (error)
    return (
      <ErrorState
        error={error}
  ...
  const applicationProcessSection =
    contentSections["E-VISA APPLICATION PROCESS"] || [];
  ...
  const processSteps = [
    {
      icon: FileText,
      title: "Apply Online",
      desc: "Upload Photo and Passport Page",
    },
    {
      icon: CreditCard,
      title: "Pay eVisa Fee",
      desc: "Online Using Credit / Debit card / Payment Wallet",
    },
    {
      icon: Mail,
      title: "Receive ETA Online",
      desc: "Electronic Travel Authorization Will be sent to your e-mail",
    },
    {
      icon: Plane,
      title: "Fly to India",
      desc: "Present your ETA at the airport",
    },
  ];
  ...
  const whyChooseFeatures = [
    {
      ...
      desc: "100% secure processing with data protection",
    },
    {
      icon: Clock,
      title: "Fast Processing",
      desc: "Quick turnaround time for your eVisa",
    },
    {
      icon: Users,
    ...
    },
    {
      icon: Globe,
      title: "Global Reach",
      desc: "Serving travelers from 150+ countries",
    },
  ];
                ...
                <div className="mb-6">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-white text-xs leading-relaxed">
                      I agree to receive communication regarding my visa
                      application and promotional offers from DU Global
                    </span>
                  </label>
                </div>
            ...
            {heroSection.map((item, index) => (
              <div
                ...
                <div>
                  ...
                  <div
                    className="w-20 h-0.75 mb-6"
                    style={{ backgroundColor: "#e63938" }}></div>
                  <div
                    ...
                    <div className="relative">
                      ...
                      {item.badge?.text && (
                        <div
                          ...
                          style={{
                            backgroundColor: item.badge.background || "#e63938",
                          }}>
                          <span className="text-xs font-medium leading-tight px-2">
                            {item.badge.text}
                          </span>
                        </div>
                      )}
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <div
                ...
                style={{ backgroundColor: "#FF1F3D" }}></div>
            </div>

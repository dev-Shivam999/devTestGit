  ...
  if (loading) {
    return (
      <div className="w-full">
        <section
          className="min-h-[800px] sm:h-[800px] bg-cover bg-center relative flex items-center justify-center"
          style={{
            backgroundImage: `url(${"/assets/video-gallery/video-gallery-bg.jpg"})`,
          }}>

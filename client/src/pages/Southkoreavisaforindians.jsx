...
const Southkoreavisaforindians = () => {
  ...
  const fetchFormData = async () => {
    try {
      ...
      const response = await fetch(
        `${BackendURL}/api/forms/slug/south-korea-visa-for-indians`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${BackendURL}/api/form-submissions/slug/south-korea-visa-for-indians`,
        {
          method: "POST",
  ...
  if (loading)
    return <LoadingState message="Loading South Korea Visa..." fullScreen />;
  if (error)
    return (
      <ErrorState
        error={error}
  ...
  const visaTypesSection =
    contentSections["South Korea Visa Types with Fees"] || [];
  const embassySection =
    contentSections[
      "Designated Travel Agency by the Embassy of the Republic of Korea in India"
    ] || [];
  const ktoSection =
    contentSections[
      "Designated Travel Agency for the Korea Tourism Organization (KTO)"
    ] || [];
  ...
  const howToApplySection =
    contentSections["How to Apply for your South Korea Visa"] || [];
  ...
  return (
    <div className="bg-white font-sans">
      {/* ===== HERO SECTION ===== */}
      <section
        className="relative w-full min-h-[800px] sm:h-[800px] overflow-hidden bg-cover bg-center"
        style={{
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(10,10,10,0.9) 0%, rgba(26,26,26,0.85) 50%, rgba(10,10,10,0.9) 100%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at right center, #E31E24 0%, transparent 70%)",
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
            ...
            <div className="text-white">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                ...
                <span style={{ color: "#E31E24" }}>Apply Now!</span>
              </h1>
              ...
              {additionalReqSection.map((item, index) => (
                <div
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, transparent 50%, rgba(227,30,36,0.2) 50%)",
                    }}
                  />
                </div>
              ))}
              ...
              {employedSection.map((item, index) => (
                <div
                  ...
                  <div
                    className="text-5xl font-bold mb-4"
                    style={{ color: "#E31E24" }}>
                    {String(additionalReqSection.length + index + 1).padStart(
                      2,
                      "0"
                    )}
                  </div>
        ...
        <section className="py-20 bg-black relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6">
            ...
            <p className="text-gray-400 text-center max-w-3xl mx-auto mb-12">
              We offer expert help and guidance to people throughout their visa
              journey. And that's the reason why many choose us for their visa
              application. And this is why people choose us.
            </p>

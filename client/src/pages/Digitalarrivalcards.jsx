...
const STATIC_IMAGES = {
  ...
  whyChoose:
    "https://images.unsplash.com/photo-1521295121783-8a321d551ad2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
};
...
const Digitalarrivalcards = () => {
  ...
  const fetchFormData = async () => {
    try {
      ...
      const response = await fetch(
        `${BackendURL}/api/forms/slug/digital-arrival-cards`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${BackendURL}/api/form-submissions/slug/digital-arrival-cards`,
        {
          method: "POST",
  ...
  if (loading)
    return (
      <LoadingState message="Loading Digital Arrival Cards..." fullScreen />
    );
  if (error)
    return (
      <ErrorState
  ...
  const travelReadySection =
    contentSections["Travel Ready with DU Global"] || [];
    ...
    <div className="bg-white font-sans">
      ...
      <section
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(15,15,30,0.95) 0%, rgba(30,15,20,0.95) 100%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed">
            ...
            <span className="text-white font-medium">
              Thailand, Malaysia, Indonesia, Singapore, South Korea, or Taiwan
            </span>
          </p>
        </div>
      </section>
          ...
          <div
                ...
                <div key={step.number} className="flex items-center flex-1">
                  <div className="flex flex-col items-center">
                    ...
                    <span
                      ...
                      style={{
                        color:
                          currentStep === step.number ? "#C00C02" : "#6b7280",
                      }}>
                      {step.label}
                    </span>
                  </div>
                  {index < formSteps.length - 1 && (
                    <div
                      ...
                      style={{
                        backgroundColor:
                          currentStep > step.number ? "#C00C02" : "#d1d5db",
                      }}
                    />
                  )}
                </div>
            ...
            {currentStep === 1 && (
              <form onSubmit={handleSubmit}>
                ...
                {submitStatus && (
                  <div
                    className={`flex items-center gap-3 p-3 rounded mt-6 ${
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <div
                ...
                style={{ backgroundColor: "#C00C02" }}></div>
            </div>

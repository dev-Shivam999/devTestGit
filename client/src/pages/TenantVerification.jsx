...
const TenantVerification = () => {
  ...
  const fetchFormData = async () => {
    try {
      ...
      const response = await fetch(
        `${BackendURL}/api/forms/slug/tenant-and-domestic-help-verification`
      );
  ...
  if (loading)
    return (
      <LoadingState message="Loading verification details..." fullScreen />
    );
  if (error)
    return (
      <ErrorState
  ...
  const whyChooseSection =
    contentSections["Why Choose DuVerify Platform?"] || [];
  ...
  const getPlanColor = (index, planName) => {
    ...
    if (name.includes("basic") || name.includes("pricing"))
      return planColors[0];
  ...
  const staticBenefits = [
    {
      icon: Target,
      title: "Peace of Mind",
      desc: "Ensure tenants, drivers, maids, and nannies are thoroughly verified.",
    },
    {
      icon: CheckCircle,
      title: "Fast & Accurate",
      desc: "Results delivered within 4–6 hours for timely decisions.",
    },
    {
      icon: Phone,
      title: "Reliable Support",
      desc: "Our team ensures you're supported at every step.",
    },
    {
      icon: Share2,
      title: "Easy Sharing",
      desc: "Share verification reports instantly with others.",
    },
  ];
      ...
      <section className="relative w-full min-h-[800px] sm:h-[800px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 min-h-[90vh] flex items-center">
          <div className="max-w-3xl text-white">
            ...
            {/* CTA */}
            <button className="px-8 py-3 rounded-full font-bold text-lg transition-all duration-300 bg-[#FF1033] text-[#FFFDF5] hover:bg-[#511313] hover:text-[#FF1033] shadow-xl cursor-pointer">
              ...
              <div
                ...
                <div>
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
                    Why Choose <span className="text-[#A10000]">DuVerify</span>{" "}
                    Platform?
                  </h2>

                  <p className="text-xl font-semibold md:font-bold text-gray-800 mb-6">
                    Protect your home and family with our tenant, maid, nanny
                    and driver background screening
                  </p>
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-3 mt-0">
                    {services.map((service, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-2 border-r border-[#A10000] pr-5 last:border-r-0">
                        <span className="text-[#A10000] text-lg font-bold">
                          ✓
                        </span>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-lg text-gray-700 font-medium">
                Flexible pricing for hassle-free Tenant, Maid, Nanny & Driver
                verification
              </p>
            </div>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {pricingFeatures.map((feature, fIndex) => (
                    <tr key={fIndex} className="border-t border-gray-200">
                  ...
                  <tr className="border-t-2 border-gray-300 bg-gray-50">
                    ...
                    {pricingPlans.map((plan, index) => {
                      ...
                      if (planName.includes("standard"))
                        price = exactPrices.standard;
                      if (planName.includes("premium"))
                        price = exactPrices.premium;
                      ...
                      <div key={item._id || index} className="space-y-6">
                        {steps.map((step, stepIdx) => (
                          <div
                            ...
                            <div className="w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold shrink-0 text-[#A10000] border-2 border-[#A10000]">
                              {stepIdx + 1}
                            </div>
                            <div className="flex-1 pt-1">
                              <p className="text-[#333333] text-lg font-bold">
                                {step}
                              </p>
                            </div>
                          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="text-center mb-16">
              ...
              {deliverablesSection[0]?.badge?.text && (
                <p className="text-[#333333] text-lg font-bold mt-4">
                  {deliverablesSection[0].badge.text}
                </p>
              )}
            </div>
            ...
            <div className="divide-y">
              {faqs.map((item, index) => (
                <div key={index} className="py-6">
                  ...
                  {openFaqIndex === index && (
                    <p className="mt-4 text-gray-500 max-w-xl">{item.answer}</p>
                  )}
                </div>
              ))}
            </div>

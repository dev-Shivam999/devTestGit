...
const Dubai5yeartouristvisa = () => {
  ...
  const fetchFormData = async () => {
    try {
      ...
      const response = await fetch(
        `${BackendURL}/api/forms/slug/dubai-5year-tourist-visa`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${BackendURL}/api/form-submissions/slug/dubai-5year-tourist-visa`,
        {
          method: "POST",
  ...
  if (loading)
    return (
      <LoadingState message="Loading Dubai 5-Year Tourist Visa..." fullScreen />
    );
  if (error)
    return (
      <ErrorState
  ...
  const exploreSection =
    contentSections["Explore UAE with a 5-year Tourist Visa"] || [];
  const feesSection =
    contentSections[
  ...
  const whyChooseFeatures = [
    {
      ...
      desc: "Premium service at competitive pricing",
    },
    {
      icon: Clock,
      title: "Fast Processing",
      desc: "Quick turnaround for your visa application",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      desc: "17 Lac+ happy customers worldwide",
    },
  ];
    ...
    <div className="bg-white font-sans">
      ...
      <section className="relative w-full min-h-[800px] sm:h-[800px] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${
              getImageUrl(formData?.image) || STATIC_IMAGES.hero
            })`,
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(0,30,50,0.85) 0%, rgba(0,50,70,0.75) 100%)",
          }}
        />

        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 min-h-[800px] sm:h-[800px] flex items-center">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  {fields
                    ...
                    .map((field, index) => (
                      <label
                        key={field._id || index}
                        className="flex items-start gap-3 text-gray-300 text-xs cursor-pointer">
                        <input
                          type="checkbox"
                          name={field.name}
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            {feesSection.map((item, index) => (
              <div
                ...
                <button className="px-10 py-4 rounded-lg font-bold text-lg transition-all duration-300 bg-[#FF1033] text-[#FFFDF5] hover:bg-[#511313] hover:text-[#FF1033]">
                  Enquire Now
                </button>
              </div>
            ))}
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Quality Beyond Compromise, Value That Is Unmatched.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Optimum use of evolving technology to strengthen our
                    portfolio and service mechanism
                  </p>
                </div>
              </div>
            </div>
